...
Fig. \ref{fig:cpr_and_stand}b shows that we still have the problem that the residuals are decreasing, which is problematic for our assumption of homoscedasticity.
